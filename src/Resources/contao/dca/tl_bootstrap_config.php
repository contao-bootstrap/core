...
(
    ...
    (
        ...
        'oncreate_callback' => array(
            array(
                'contao_bootstrap.core.dca.bootstrap_config',
    ...
    (
        ...
        (
            ...
            'inputType'        => 'select',
            'filter'           => true,
            'options_callback' => array('contao_bootstrap.core.dca.bootstrap_config', 'getTypes'),
            'reference'        => &$GLOBALS['TL_LANG']['bootstrap_config_type'],
            'save_callback'    => array(
                array('contao_bootstrap.core.dca.bootstrap_config', 'importFromConfig'),
            ),
            'load_callback'    => array(
                array('contao_bootstrap.core.dca.bootstrap_config', 'warnByGlobalConfig'),
            ),
            'eval'             => array(
                'tl_class'           => 'w50',
        ...
        (
            ...
            'inputType' => 'text',
            'options_callback' => array('contao_bootstrap.core.dca.bootstrap_config', 'getNames'),
            'eval'      => array(
                'tl_class'           => 'w50',
                'mandatory'          => true,
                'includeBlankOption' => true,
